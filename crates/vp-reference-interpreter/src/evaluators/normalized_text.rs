//! Normalized text assertion evaluator — VP-RFC-0011 / Platform 1.3.

use vp_reference_core::{EvaluationContext, SpecificationContext};
use vp_reference_model::{
    SpecificationBinding, Trace, VerificationResult, VerificationResultBuilder,
};
...
/// Normative assertion type per VP-RFC-0011.
pub const NORMALIZED_TEXT_ASSERTION_TYPE: &str = "normalized_text";

/// Normalized text evaluator — maps to **VP-RULE-0002** then **VP-RULE-0011**.
#[derive(Debug)]
pub struct NormalizedTextEvaluator {
    rule_set: RuleSet,
}

impl NormalizedTextEvaluator {
    #[must_use]
    pub fn new() -> Self {
        Self::with_rule_set(RuleSet::platform_1_3())
    }
...
impl Default for NormalizedTextEvaluator {
    fn default() -> Self {
        Self::new()
    }
}

impl AssertionEvaluator for NormalizedTextEvaluator {
